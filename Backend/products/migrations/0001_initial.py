# Generated by Django 5.2.6 on 2026-08-25 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('availability', models.CharField(choices=[('in_stock', 'In Stock'), ('out_of_stock', 'Out of Stock'), ('coming_soon', 'Coming Soon'), ('pre_order', 'Pre Order')], default='in_stock', max_length=20)),
                ...
                ('colors', models.JSONField(blank=True, default=products.models.Product.default_color)),
                ('is_active', models.BooleanField(default=True)),
                ('is_featured', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', models.JSONField(blank=True, default=products.models.ProductVariant.default_options)),
